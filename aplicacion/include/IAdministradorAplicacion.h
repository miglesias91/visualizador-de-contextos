...
public:
    ...
    static bool administradorResultadosIniciado();
    ...
    static IAdministradorAplicacion* getInstanciaAdminResultados();
...
private:
    ...
    static IAdministradorAplicacion* administrador_resultados;
